...
def file_list_generator(target_dir,
                        ...
                        prefix_masked="masked",  # Add prefix_masked argument
                        ext="wav"):
    """
    target_dir : str
        base directory path
    ...
    # development
    if mode:
        query_normal = os.path.abspath("{target_dir}/{dir_name}/{section_name}_*_{prefix_normal}_*.{ext}".format(target_dir=target_dir,
                                                                                                                  dir_name=dir_name,
        ...
        query_anomaly = os.path.abspath("{target_dir}/{dir_name}/{section_name}_*_{prefix_anomaly}_*.{ext}".format(target_dir=target_dir,
                                                                                                                    dir_name=dir_name,
                                                                                                                    section_name=section_name,
        ...
        query_masked = os.path.abspath("{target_dir}/{dir_name}/{section_name}_*_{prefix_masked}_*.{ext}".format(target_dir=target_dir,
                                                                                                                    dir_name=dir_name,
                                                                                                                    section_name=section_name,
